...
type WelcomeSliderNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  "WelcomeSlider"
>;
...
const slides = [
  {
    ...
    description:
      "Your personal assistant for organizing daily tasks and boosting productivity.",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    description:
      "Set up task relationships and track what needs to be done first.",
  },
  {
    id: "4",
